...
int main()
{
    ...
    int dl = sizeof(x) / sizeof(x[0]); //длины е е наход
    double xi = 0;
    double yi = 0;
    double xi2 = 0;
    double xiyi = 0;
    ...
    cout << " y = " << la << "x + " << lb << " c discrepat Q = " << Q << " i quadraticum dependentiam y = " << ka << "x2 + " << kb << " x " << kc << " c  discrepat Q = " << kQ << endl;
    return 0;
}
